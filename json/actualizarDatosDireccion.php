...
if(!$res){
    ...
    $ident=$resobj->ident;
    $query2="update usuarios_facturacion set usuarios_facturacion.nombre_direccion='".$_POST["data"][0][1]."',  usuarios_facturacion.codigo_postal='".$_POST["data"][1][1]."', usuarios_facturacion.localidad='".$_POST["data"][2][1]."', usuarios_facturacion.direccion='".$_POST["data"][3][1]."', usuarios_facturacion.telefono=".$_POST["data"][4][1]." where ident=$ident;";
