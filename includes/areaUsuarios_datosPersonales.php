<form class="form form_datosPersonales" id="form_datosPersonales" onsubmit="control_comprobarFormDatosPersonales(event,this);">
    <h4>Datos Personales</h4>
        ...
        <span class="form_label-input-container"><label>Cambiar Email: </label><input type="email" id="input_cambiarEmail" data-preVal="<?php echo $_POST["data"][3]?>"><span class="form_campo_info"></span><span class="form_campo_obligatorio">&nbsp;&nbsp;</span><span class="form_campo_ayuda"><i class="fa fa-question-circle" aria-hidden="true"></i></span></span>
